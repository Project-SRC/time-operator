# Contributing to Project SRC - Time Operator

We would love for you to contribute to `Time Operator` and help make it even better than it is
...
[coc]: https://github.com/Project-SRC/time-operator/blob/master/docs/CODE_OF_CONDUCT.md

## <a name="question"></a> Got a Question or Problem?

Do not open issues for general support questions as we want to keep GitHub issues for bug reports and feature requests. You've got much better chances of getting your question answered on [Stack Overflow](https://stackoverflow.com/questions/tagged/openfaas) where the questions should be tagged with tag `openfaas`.
...
You can file new issues by selecting from our [new issue templates](https://github.com/Project-SRC/time-operator/issues/new) and filling out the issue template.

### <a name="submit-pr"></a> Submitting a Pull Request (PR)

Before you submit your Pull Request (PR) consider the following guidelines:

1. Search [GitHub](https://github.com/Project-SRC/time-operator/pulls) for an open or closed PR
...
[coc]: https://github.com/Project-SRC/time-operator/code-of-conduct/blob/master/docs/CODE_OF_CONDUCT.md
[dev-doc]: https://github.com/Project-SRC/time-operator/code-of-conduct/blob/master/README.md
[commit-message-format]: https://docs.google.com/document/d/1QrDFcIiPjSLDn3EL15IJygNPiHORgU1_OOAqWjiDU5Y/edit#
[github]: https://github.com/Project-SRC/time-operator
